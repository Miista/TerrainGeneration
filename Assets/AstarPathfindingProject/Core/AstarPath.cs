...
#region InspectorDebug
	...
	/** Rank of the red cubes shown in place of unwalkable nodes.
	 *
	 * \note Only relevant in the editor
...
#region InspectorSettings
	 ...
	 * you should set this variable to 0.\n
	  * Can be found in A* Inspector-->Settings-->Min Area Rank
	  *
...
#region ScanMethods
	...
	public void FloodFill () {
		...
		if (warnAboutAreas) {
			Debug.LogError ("Too many areas - The maximum number of areas is " + GraphNode.MaxAreaIndex +". Try raising the A* Inspector -> Settings -> Min Area Rank value. Enable the optimization ASTAR_MORE_AREAS under the Optimizations tab.");
		}
		...
		if (smallAreasDetected > 0) {
			AstarLog (smallAreasDetected +" small areas were detected (fewer than "+minAreaSize+" nodes)," +
				...
				"\nWhich areas are defined as 'small' is controlled by the 'Min Area Rank' variable, it can be changed in the A* inspector-->Settings-->Min Area Rank" +
