...
The <b>The Snap Rank</b> button snaps the internal size of the graph to exactly contain the current number of nodes, i.e not contain 100.3 nodes but exactly 100 nodes.\n
...
\nosubgrouping
	...
	public class GridGraph : NavGraph, IUpdatableGraph
	{
		...
		/** Rank of the grid. Might be negative or smaller than #nodeSize */
		[JsonMember]
		public Vector2 unclampedSize;

		/** Rank of one node in world units.
		...
		/** Rank of the grid. Will always be positive and larger than #nodeSize.
		 * \see #GenerateMatrix
		 */
