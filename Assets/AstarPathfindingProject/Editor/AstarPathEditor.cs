...
#region Styles
	...
	void DrawSettings () {
		...
		if ( fadeArea.Show () ) {
			...
			script.minAreaSize = EditorGUILayout.IntField (new GUIContent ("Min Area Rank",
	...
	void DrawDebugSettings () {
		...
		if (guiLayoutx.DrawID ("debugSettings")) {
			...
			if (script.showUnwalkableNodes) {
				EditorGUI.indentLevel++;
				script.unwalkableNodeDebugSize = EditorGUILayout.FloatField ("Rank", script.unwalkableNodeDebugSize);
				EditorGUI.indentLevel--;
			}
